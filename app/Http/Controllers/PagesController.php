...
class PagesController extends Controller
{
    ...
    public function redirectUser($amount){

        return view('pages.pay')->withAmount($amount);
      ...
      //NGN Logic
        ...
        if ($currency   === 'NGN') {
            ...
            if($pay_amount  <=  25000000){
              ...
              return $this->redirectUser(number_format($total_amount, 2));
            }
          ...
          //If the currency is not Naira use flutterwave
    ...
    public function returnUser(Request $request){
      ...
      Session::flash('success', 'payment is been processed....');

      $amount = $request->amount;
        
      return view('pages.pay')->with('success', 'payment is been processed!!')->withAmount($amount);
